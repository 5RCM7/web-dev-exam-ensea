...
export const renderRecipeCard = (recipe) => {
	...
	// Utiliser l'image de la recette si disponible, sinon une image par défaut
	const recipeImage = recipe.image || "https://images.pexels.com/photos/5190684/pexels-photo-5190684.jpeg"

	return `
		<div class="col-md-6 col-lg-4">
			<div class="card h-100 shadow-sm hover-shadow transition">
				<img src="${recipeImage}" class="card-img-top" alt="${recipe.name}" style="max-height: 200px; object-fit: cover;">
...
export const renderSingleRecipe = (recipe) => {
	...
	<div class="row">
		<div class="col-12">			
			...
			<img src="${recipe.image || 'https://images.pexels.com/photos/5190684/pexels-photo-5190684.jpeg'}" class="card-img-top" alt="${recipe.name}" style="max-height: 300px; object-fit: cover;">
